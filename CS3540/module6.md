# [Module 6 -- Decision Trees and Ensemble Learning](https://github.com/Hanif-K-Musaheb/Year-3-CS-UVM-Study-Abroad-/blob/main/CS3540/CS3540.md)
### ensable learning
...
>Instead of changing the model target, AdaBoost changes the weights of the training data.
...
**Residual error**: The difference between the actual value and the predicted value.
 ...
 - Instead of tweaking the instance weights at every iteration like AdaBoost does, this
method tries to fit the new predictor to the **residual errors** made by the previous predictor.

>Instead of changing weights, it trains each new model to predict the residual errors of the previous model.
“What did the last model get wrong numerically? Let me predict that.”
